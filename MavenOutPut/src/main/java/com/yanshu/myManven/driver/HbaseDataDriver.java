package com.yanshu.myManven.driver;
...
import com.yanshu.hbase.tableinputformat.CalendarUtil;
import com.yanshu.hbase.tableinputformat.MultiRangeTableInputFormat;
...
public class HbaseDataDriver {
	...
	/*
	 * 
	 * hadoop jar ./MyMaven-0.0.1-SNAPSHOT.jar
	 * com.yanshu.myManven.driver.HbaseDataDriver \ -zkserver localhost \
	 * -serverAddress localhost \ -tableName dbTest \ -startKey row-key1 \
	 * -endKey row-key2 \ -jobName yanshu \ -output /extract_data \ -mapper
	 * com.yanshu.myManven.mappers.ExtarctDataMapper
	 */
	public static void main(String[] args) throws Exception {
		...
		config.set("yarn.resourcemanager.scheduler.address", serverAddress
				+ ":8030");
...
//		scan = new Scan(Bytes.toBytes(String.valueOf(startKey)),
//				Bytes.toBytes(String.valueOf(endKey)));
